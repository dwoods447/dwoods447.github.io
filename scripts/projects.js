const projects = [
    ...
    dateStarted: '',
    dateCompeleted: ``,
    description: 'ImSeekingGeeks is an online dating platform built with Vue 3, Typescript and Vite',
    mainImage: './images/fulls/online-dating-promo-main.jpg',
    mainUrl: '',
    documentsLinks: [],
    github: 'https://github.com/dwoods447/im-seeking-geeks-2.0-ui',
    skillsUsed: [
      'vue.js',
      'typescript',
      'vite'
   ...
   },
   {
    ...
    dateStarted: '',
    dateCompeleted: ``,
    description: 'ImSeekingGeeks is an online dating platform built with Express.js, Typescriptm MongoDB',
    mainImage: './images/fulls/online-dating-promo-main.jpg',
    mainUrl: '',
    documentsLinks: [],
...
//    },
    ...
    },
   {
    ...
    date: '',
    description: 'Personal Dragonball fansite re-built using Laravel 5.7, and Vue 2',
